...
namespace Runtime.Cards
{
    public class DiskIICard : ICard
    {
        ...
        public void Write(ushort address, byte b, MainBoard mainBoard)
        {
            ...
            var sec = mainBoard.softswitches.Drive1_2 ? (drive1.FlagDos_Prodos ? mainBoard.ReadByte(0x2d) : mainBoard.ReadByte(0xd357)) : (drive2.FlagDos_Prodos ? mainBoard.ReadByte(0x2d) : mainBoard.ReadByte(0xd357));
            var trk = mainBoard.softswitches.Drive1_2 ? drive1.track : drive2.track;
            ...
            {
                if (mainBoard.softswitches.DriveQ6H_L == false && mainBoard.softswitches.DriveQ7H_L == true)
                {
            ...
            ProcessSwitchc080(address, b, mainBoard, null);
        ...
        public byte Read(ushort address, MainBoard mainBoard, State state)
        {
            ...
            {
                if (mainBoard.softswitches.DriveQ6H_L == false && mainBoard.softswitches.DriveQ7H_L == false)
                {
            ...
            return ProcessSwitchc080(address, 0, mainBoard, state);
        }

        private byte ProcessSwitchc080(ushort address, byte b, MainBoard mainBoard, State? state)
        {

            if (address == 0xc080 + _slotNumber * 0x10)
            {
                mainBoard.softswitches.DrivePhase0ON_OFF = false;
                if (mainBoard.softswitches.Drive1_2)
            ...
            {
                mainBoard.softswitches.DrivePhase0ON_OFF = true;
                if (mainBoard.softswitches.Drive1_2)
            ...
            {
                mainBoard.softswitches.DrivePhase1ON_OFF = false;
                if (mainBoard.softswitches.Drive1_2)
            ...
            {
                mainBoard.softswitches.DrivePhase1ON_OFF = true;
                if (mainBoard.softswitches.Drive1_2)
            ...
            {
                mainBoard.softswitches.DrivePhase2ON_OFF = false;
                if (mainBoard.softswitches.Drive1_2)
            ...
            {
                mainBoard.softswitches.DrivePhase2ON_OFF = true;
                if (mainBoard.softswitches.Drive1_2)
            ...
            {
                mainBoard.softswitches.DrivePhase3ON_OFF = false;
                if (mainBoard.softswitches.Drive1_2)
            ...
            {
                mainBoard.softswitches.DrivePhase3ON_OFF = true;
                if (mainBoard.softswitches.Drive1_2)
            ...
            {
                mainBoard.softswitches.DriveMotorON_OFF = false;
                if (mainBoard.softswitches.Drive1_2)
                    drive1.on = false;
                else
                    drive2.on = false;
            ...
            {
                mainBoard.softswitches.DriveMotorON_OFF = true;
                if (mainBoard.softswitches.Drive1_2)
                {
                    drive1.on = true;
                    drive2.on = false;
