...
namespace Apple2Sharp.CPU65C02
{
    internal static class IncAndDecOpCodeProcessors
    {
        ...
        public static void Process_INA(State processorState)
        {
            var value = (byte)(processorState.A + 1);
            SetA(processorState, value);
            WithFlags(processorState, value);
        }

        public static void Process_DEA(State processorState)
        {
            var value = (byte)(processorState.A - 1);
            SetA(processorState, value);
            WithFlags(processorState, value);
        ...
        private static void SetA(State processorState, byte value)
        {
